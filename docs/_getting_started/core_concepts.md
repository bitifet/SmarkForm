...
{% include_relative examples/core_concepts.examples.md option="simple_form" %}
...
{% include_relative examples/core_concepts.examples.md option="inner_exports_form" %}
...
{% include_relative examples/core_concepts.examples.md option="nested_forms" %}
...
{% include_relative examples/core_concepts.examples.md option="fixed_list" %}
...
{% include_relative examples/core_concepts.examples.md option="pets_list" %}
