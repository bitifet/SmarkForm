...
<div id="example{{ formId }}" class="tab-container">
  ...
  {
    "html": {{ preview_source | jsonify | replace: "  ", "\u0020\u0020" | replace: "<", "\u003c" }},
    "htmlSource": {{ partial_htmlSource | jsonify | replace: "  ", "\u0020\u0020" | replace: "<", "\u003c" }},
    "css": {{ cssSource | jsonify | replace: "  ", "\u0020\u0020" | replace: "<", "\u003c" }},
    "cssHidden": {{ cssHidden | jsonify | replace: "  ", "\u0020\u0020" | replace: "<", "\u003c" }},
    "jsHead": {{ jsHead | jsonify | replace: "  ", "\u0020\u0020" | replace: "<", "\u003c" }},
    "jsHeadDisplay": {{ jsHead_display | jsonify | replace: "  ", "\u0020\u0020" | replace: "<", "\u003c" }},
    "jsHeadDisplayWithEditor": {{ jsHead_display_with_editor | jsonify | replace: "  ", "\u0020\u0020" | replace: "<", "\u003c" }},
    "jsHidden": {{ jsHidden | jsonify | replace: "  ", "\u0020\u0020" | replace: "<", "\u003c" }},
