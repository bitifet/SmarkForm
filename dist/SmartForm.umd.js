...
);const d=this;d.target.dataset[d.property_name]=c,d.target.addEventListener("click",onActionClick.bind(d),!0);}}exports.SmartForm=SmartForm;exports.createComponent=createComponent;Object.defineProperty(exports,'__esModule',{value:true});}));